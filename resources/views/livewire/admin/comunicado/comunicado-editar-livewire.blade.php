@section('tituloPagina', 'Editar comunicado')
@section('anchoPantalla', '100%')

<div x-data="dataComunicadoEditar" class="g_gap_pagina">
    <!-- CABECERA -->
    <div class="g_panel cabecera_titulo_pagina">
        ...
        <div class="cabecera_titulo_botones">
            ...
            <button type="button" class="g_boton g_boton_danger" onclick="alertaEliminarComunicado()">
    ...
    <div class="formulario">
            ...
            <div class="g_columna_8 g_gap_pagina">
                ...
                <div class="g_panel">
                    ...
                    <table class="tabla_eliminar">
                        ...
                        <tbody x-sort="handleComunicadoEditar">
        ...
        <div class="g_margin_top_20">
            <div class="formulario_botones">
                ...
                <a href="{{ route('admin.comunicado.vista.todo') }}" class="cancelar">Cancelar</a>
            </div>
        </div>
    </div>

    <script>
        function alertaEliminarComunicado() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('eliminarComunicadoOn');
        ...
        function dataComunicadoEditar() {
            return {
                handleComunicadoEditar(item, position) {
                    Livewire.dispatch('handleComunicadoEditarOn', {
                        item,
                        position
                    });
                },
