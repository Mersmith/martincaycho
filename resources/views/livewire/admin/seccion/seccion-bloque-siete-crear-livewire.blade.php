@section('tituloPagina', 'Crear bloque 7')
@section('anchoPantalla', '100%')

<div x-data="dataBloque7Crear()" class="g_gap_pagina">

    <!-- CABECERA -->
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Crear bloque 7</h2>
        ...
        <div class="g_fila">
            ...
            <div class="g_columna_8 g_gap_pagina">
                ...
                <div class="g_panel">
                    ...
                    <!-- LISTA -->
                    <div x-sort="handleBloque7Crear" class="g_gap_pagina">
    ...
    <script>
        function dataBloque7Crear() {
            return {
                ...
                handleBloque7Crear(item, position) {
                    Livewire.dispatch('handleBloque7CrearOn', {
                        item,
                        position
                    });
                }
