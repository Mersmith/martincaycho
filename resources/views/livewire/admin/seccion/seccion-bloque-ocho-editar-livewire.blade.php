@section('tituloPagina', 'Editar bloque 8')
@section('anchoPantalla', '100%')

<div x-data="dataBloque8Editar()" class="g_gap_pagina">

    <!-- Editar -->
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar bloque 8</h2>

        <div class="cabecera_titulo_botones">
            <a href="{{ route('admin.seccion.bloque-ocho.vista.todo') }}" class="g_boton g_boton_light">
                Inicio <i class="fa-solid fa-house"></i>
            </a>

            <button type="button" class="g_boton g_boton_danger" onclick="alertaEliminarBloque8()">
                Eliminar <i class="fa-solid fa-trash-can"></i>
            </button>

            <a href="{{ route('admin.seccion.bloque-ocho.vista.todo') }}" class="g_boton g_boton_darkt">
    ...
    <form wire:submit.prevent="store" class="formulario">
        ...
        <div class="g_fila">
            ...
            <div class="g_columna_8 g_gap_pagina">
                ...
                <div class="g_panel">
                    ...
                    <!-- LISTA -->
                    <div x-sort="handleBloque8Editar" class="g_gap_pagina">
                        ...
                        <div class="g_panel tabla_caja" x-sort:item="{{ $item['id'] }}">
                            ...
                            <div x-show="itemsVisibility[{{ $index }}]" x-transition>
                                <div class="g_fila">
                                    <div class="g_margin_bottom_10">
                                        <label>Nombres</label>
                                        <input type="text" wire:model="lista.{{ $index }}.titulo" @pointerdown.stop
                                ...
                                <div class="g_fila">
                                    <div class="g_margin_bottom_10">
                                        <label>Imagen</label>
                                        <input type="text" wire:model="lista.{{ $index }}.imagen" @pointerdown.stop
                                            @mousedown.stop @touchstart.stop draggable="false">
                                    </div>

                                    <div class="g_margin_bottom_10">
                                        <label>SEO Imagen</label>
                                        <input type="text" wire:model="lista.{{ $index }}.imagen_seo" @pointerdown.stop
                                            @mousedown.stop @touchstart.stop draggable="false">
        ...
        <div class="g_margin_top_20">
            <div class="formulario_botones">
                ...
                <a href="{{ route('admin.seccion.bloque-ocho.vista.todo') }}" class="cancelar">Cancelar</a>
            </div>
        </div>
    ...
    <script>
        function dataBloque8Editar() {
            return {
                ...
                handleBloque8Editar(item, position) {
                    Livewire.dispatch('handleBloque8EditarOn', {
                        item,
                        position
                    });
                }
        ...
        function alertaEliminarBloque8() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('eliminarSeccion8On');
