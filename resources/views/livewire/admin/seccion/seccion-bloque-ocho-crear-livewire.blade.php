@section('tituloPagina', 'Crear bloque 8')
@section('anchoPantalla', '100%')

<div x-data="dataBloque8Crear()" class="g_gap_pagina">

    <!-- CABECERA -->
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Crear bloque 8</h2>
        ...
        <div class="g_fila">
            ...
            <div class="g_columna_8 g_gap_pagina">
                ...
                <div class="g_panel">
                    ...
                    <!-- LISTA -->
                    <div x-sort="handleBloque8Crear" class="g_gap_pagina">
    ...
    <script>
        function dataBloque8Crear() {
            return {
                ...
                handleBloque8Crear(item, position) {
                    Livewire.dispatch('handleBloque8CrearOn', {
                        item,
                        position
                    });
                }
