@section('tituloPagina', 'Editar bloque 4')
...
<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar bloque 4</h2>

        <div class="cabecera_titulo_botones">
            <a href="{{ route('admin.seccion.bloque-cuatro.vista.todo') }}" class="g_boton g_boton_light">
                Inicio <i class="fa-solid fa-house"></i></a>

            <a href="{{ route('admin.seccion.bloque-cuatro.vista.crear') }}" class="g_boton g_boton_primary">
                Crear <i class="fa-solid fa-square-plus"></i></a>

            <button type="button" class="g_boton g_boton_danger" onclick="alertaEliminarBloque4()">
                Eliminar <i class="fa-solid fa-trash-can"></i>
            </button>

            <a href="{{ route('admin.seccion.bloque-cuatro.vista.todo') }}" class="g_boton g_boton_darkt">
    ...
    <form wire:submit.prevent="store" class="formulario">
        ...
        <div class="g_margin_top_20">
            <div class="formulario_botones">
                ...
                <a href="{{ route('admin.seccion.bloque-cuatro.vista.todo') }}" class="cancelar">Cancelar</a>
            </div>
        </div>
    </form>

    <script>
        function alertaEliminarBloque4() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('eliminarSeccion4On');
