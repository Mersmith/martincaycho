@section('tituloPagina', 'Editar bloque 9')
...
<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar bloque 9</h2>

        <div class="cabecera_titulo_botones">
            <a href="{{ route('admin.seccion.bloque-nueve.vista.todo') }}" class="g_boton g_boton_light">
                Inicio <i class="fa-solid fa-house"></i></a>

            <a href="{{ route('admin.seccion.bloque-nueve.vista.crear') }}" class="g_boton g_boton_primary">
                Crear <i class="fa-solid fa-square-plus"></i></a>

            <button type="button" class="g_boton g_boton_danger" onclick="alertaEliminarBloque9()">
            ...
            <div class="g_columna_8 g_gap_pagina">
                ...
                <div class="g_panel">
                    ...
                    <div wire:ignore style="g_ckeditor" class="g_margin_bottom_10">
                        <textarea id="content_html" class="w-full form-control" rows="6" wire:ignore x-data x-init="ClassicEditor.create($refs.miEditorEdit, {
                                toolbar: [
                                    'undo', 'redo', '|',
                                    'heading', '|',
                                    'bold', 'italic', '|',
                            ...
                            .catch(error => {
                                console.error(error);
                            });" x-ref="miEditorEdit">{!! $content_html !!}</textarea>
    ...
    <script>
        function alertaEliminarBloque9() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('eliminarSeccion9On');
