...
<div x-data="dataPaginaEditar" class="g_gap_pagina">
    <!-- CABECERA -->
    <div class="g_panel cabecera_titulo_pagina">
        ...
        <div class="cabecera_titulo_botones">
            ...
            <button type="button" class="g_boton g_boton_danger" onclick="alertaEliminarPagina()">
            ...
            <div class="g_columna_8 g_gap_pagina">
                ...
                <div class="g_panel">
                    ...
                    <table class="tabla_eliminar">
                        ...
                        <tbody x-sort="handlePaginaEditar">
    ...
    <script>
        function dataPaginaEditar() {
            return {
                handlePaginaEditar(item, position) {
                    Livewire.dispatch('handlePaginaEditarOn', {
                        item: item,
                        position: position,
                    });
                },
          ...
          function alertaEliminarPagina() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('eliminarPaginaOn');
